<template>
  ...
  <div class="max-w-7xl mx-auto flex flex-col relative">
    ...
    <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        <button @click="redirectToInicio" class="flex">
          <span class="self-center text-lg text-[#ffdb70] font-semibold whitespace-nowrap fadein-bot hover:text-amber-100">Owen Hernandez;</span>
        </button>
        <div class="flex md:order-2 fadein-bot">
          <a href="https://github.com/Owen-Hernandez"><img class="w-9 rounded-full" src="https://seeklogo.com/images/G/github-logo-2E3852456C-seeklogo.com.png" alt="github"></a>
        </div>
          ...
          <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
              <router-link to="/about"
                class="fadein-bot fadein-1 text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-gray-500 md:p-0">Acerca de mi</router-link>
            </li>
            <li>
            ...
            <!-- ACA INICIA LOS COMENTARIOS DE BLOG -->
            <!--
            <li>
              <router-link to="/blog"
            ...
            -->
            <!-- ACA TERMINA LOS COMENTARIOS DE BLOG -->
          </ul>
        </div>
      </div>
    </nav>
  ...
  <footer class="block md:hidden fixed bottom-0 left-0 right-0 rounded-t-3xl border border-[#383838] bg-[#121212] bg-opacity-80 backdrop-blur-md backdrop-opacity-90">
    <nav class="flex justify-around py-4 text-xs">
      ...
      <router-link to="/about" class="text-gray-300 hover:text-white">Acerca de mi</router-link>
