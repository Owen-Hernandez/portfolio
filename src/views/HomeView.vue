  ...
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Owen Hernandez</h1>
      <div class="py-2">
        <h1
      ...
      <p class="text-white pr-4 fade-in-from-left">Bienvenido a mi portfolio personal. <span class="wave">👋🏼</span></p>
      <br>
      <!-- <button
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://i.pinimg.com/736x/00/06/03/00060393e3f2f5a5de00f88d3bfad826.jpg"> 
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Desarrollador Junior", "1 año de experiencia", "Estudiante informatico", "Entusiasta de la tecnologia"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
