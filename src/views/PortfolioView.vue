      ...
      items: [
        {
          ...
          status: 'En mi sitio web personal, creé este sitio para mostrar mi perfil, habilidades y proyectos. Además, es mi espacio para probar nuevas tecnologías.',
        ...
        */
        // ACA TERMINAN LOS COMENTARIOS PARA QUE NO SE VISUALIZEN LAS PARTES DEL 2 AL 5
      ]
    };
  }
}
      ...
      <header>
        <div
          ...
          <h4 class="text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-amber-300">
            Explora los proyectos en los que he trabajado hasta el momento  </h4>
        </div>
      </header>
      <section>
        <div>
                  ...
                  <div class="w-full flex justify-end">
                    <div class="flex cursor-pointer items-end gap-2 text-primary">
                      <a v-if="item.github !== 'null'"
                        ...
                        title="Ver repositorio de github" class="transition-all hover:text-accent">
                        ...
                        title="Ver demo del proyecto" class="transition-all hover:text-accent">
                        <svg stroke="currentColor"
                          fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"
