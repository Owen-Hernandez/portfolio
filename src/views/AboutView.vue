    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Python',
          imageUrl: 'https://i.pinimg.com/736x/c2/37/25/c23725bd0fc6fa6840df3f85e704e5de.jpg',
          status: 'Medio'
        },
        {
          id: 7,
        ...
        },
        {
          id: 8,
          name: 'Linux',
          imageUrl: 'https://i.pinimg.com/736x/c7/b8/11/c7b8113247fecd83bd9b5ed5bd3f34d5.jpg',
          status: 'Basico'
        },
        {
          id: 9,
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://i.pinimg.com/736x/5a/53/fc/5a53fc22ce38d4d594f57cffd42b1ed4.jpg" alt="Foto acerca de mi">
        </div>
        <div class="md:w-7/12">
          ...
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; Mi trabajo en este primer año ha consistido en la revision y optimizacion de diversas consultas SQL.
            asegurando su funcionamiento para futuros desarrollos, en la ejecucion de pruebas funcionales, garantizando
            la funcionalidad de las implementaciones, y contribuyendo a resolver errores encontrados durante las pruebas.
      ...
      <section>
        <div>
          <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-5">
            ...
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-amber-200 bg-amber-200 bg-opacity-10': activeTab === 2 }" @click="activeTab = 2">Herramientas</button>
            </li>
          </ul>
        </div>
